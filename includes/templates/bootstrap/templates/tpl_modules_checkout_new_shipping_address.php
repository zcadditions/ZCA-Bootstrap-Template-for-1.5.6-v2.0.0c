...
<div id="checkoutNewShippingAddress-card" class="card mb-3">
<h4 id="checkoutNewShippingAddress-card-header" class="card-header"><?php echo TITLE_PLEASE_SELECT; ?></h4>
<div id="checkoutNewShippingAddress-card-body" class="card-body p-3">
