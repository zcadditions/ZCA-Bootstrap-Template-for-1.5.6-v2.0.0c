...
<div id="productFreeShippingInfo" class="centerColumn">
...
<div id="productFreeShippingInfo-productCategoryIcon" class="productCategoryIcon">
<?php
/**
...
<div id="productFreeShippingInfo-productPrevNextTop" class="productPrevNextTop">
<?php
/**
...
<!--bof Product Name-->
<h1 id="productFreeShippingInfo-productName" class="productName"><?php echo $products_name; ?></h1>
<!--eof Product Name-->

<div id="productFreeShippingInfo-displayRow" class="row">
   <div id="productFreeShippingInfo-displayColLeft"  class="col-sm">
...
<div id="productFreeShippingInfo-productAdditionalImages" class="productAdditionalImages text-center">
<?php
/**
...
<div id="productFreeShippingInfo-productDescription" class="productDescription mb-3"><?php echo stripslashes($products_description); ?>
</div>
<?php } ?>
...
<div id="productFreeShippingInfo-productReviewLink" class="productReviewLink mb-3"><?php echo '<a href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS, zen_get_all_get_params()) . '">' . zen_image_button(BUTTON_IMAGE_REVIEWS, BUTTON_REVIEWS_ALT) . '</a>'; ?>
</div>

<p id="productFreeShippingInfo-productReviewCount" class="productReviewCount"><?php echo ($flag_show_product_info_reviews_count == 1 ? TEXT_CURRENT_REVIEWS . ' ' . $reviews->fields['count'] : ''); ?></p>

<?php } else { ?>
<div id="productFreeShippingInfo-productReviewLink" class="productReviewLink mb-3"><?php echo '<a href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, zen_get_all_get_params(array())) . '">' . zen_image_button(BUTTON_IMAGE_WRITE_REVIEW, BUTTON_WRITE_REVIEW_ALT) . '</a>'; ?>
</div>
...
<!--eof Reviews button and count -->
  ...
  <div id="productFreeShippingInfo-displayColRight"  class="col-sm">

<!--bof Product details list  -->
<?php if ( (($flag_show_product_info_model == 1 and $products_model != '') or ($flag_show_product_info_weight == 1 and $products_weight !=0) or ($flag_show_product_info_quantity == 1) or ($flag_show_product_info_manufacturer == 1 and !empty($manufacturers_name))) ) { ?>

<ul id="productFreeShippingInfo-productDetailsList" class="productDetailsList list-group mb-3">
...
<div id="productFreeShippingInfo-productAttributes" class="productAttributes">
<?php
/**
...
<div id="productFreeShippingInfo-productFreeShippingIcon" class="productFreeShippingIcon text-center m-3"><?php echo TEXT_PRODUCT_FREE_SHIPPING_ICON; ?></div>
<?php } ?>
<!--eof free ship icon  -->
...
<div id="productFreeShippingInfo-productQuantityDiscounts" class="productQuantityDiscounts">
<?php
/**
...
<div id="productFreeShippingInfo-moduledDisplayRow" class="row">
    <?php if (PRODUCT_INFO_SHOW_NOTIFICATIONS_BOX == '1') { ?>
<!--bof Products Notification Module-->
      <div id="productFreeShippingInfo-moduleDisplayColLeft" class="col-sm">
...
<!--bof Products Manufacturer Info Module-->
  <div id="productFreeShippingInfo-moduleDisplayColRight" class="col-sm">
...
?>
<p id="productFreeShippingInfo-productDateAvailable" class="productDateAvailable text-center">
...
?>
<p id="productFreeShippingInfo-productDateAdded" class="productDateAdded text-center">
...
<div id="productFreeShippingInfo-productPrevNextBottom" class="productPrevNextBottom">
<?php
/**
 * display the product previous/next helper
 */
