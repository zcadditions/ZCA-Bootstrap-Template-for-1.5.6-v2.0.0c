...
$specials_products_price = '<div class="centerBoxContentsItem-price text-center">' . $products_price . '</div>';
/** eof products price */

/** bof products name */
    $specials_products->fields['products_name'] = zen_get_products_name($specials_products->fields['products_id']);   
    
$specials_products_name = '<div class="centerBoxContentsItem-name text-center"><a href="' . zen_href_link(zen_get_info_page($specials_products->fields['products_id']), 'cPath=' . $productsInCategory[$specials_products->fields['products_id']] . '&products_id=' . $specials_products->fields['products_id']) . '">' . $specials_products->fields['products_name'] . '</a></div>';
/** eof products name */
