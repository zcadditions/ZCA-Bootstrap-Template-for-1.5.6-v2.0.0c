              ...
              and       pov.language_id = '" . (int)$_SESSION['languages_id'] . "' " .
                ...
                while (!$products_options->EOF) {
                  ...
                  if ($products_options_names->fields['products_options_type'] == PRODUCTS_OPTIONS_TYPE_RADIO) {
                    ...
                    if (isset($_SESSION['cart']->contents[$prod_id]['attributes'][$products_options_names->fields['products_options_id']]) && $_SESSION['cart']->contents[$prod_id]['attributes'][$products_options_names->fields['products_options_id']] == $products_options->fields['products_options_values_id']) {                      } else {
                        $selected_attribute = false;
                      }
                    } else {
...
//                        $selected_attribute = ($products_options->fields['attributes_default']=='1' ? true : false);
                  ...
                  if ($products_options_names->fields['products_options_type'] == PRODUCTS_OPTIONS_TYPE_FILE) {
                    ...
                    if (zen_run_normal() == true and zen_check_show_prices() == true) {
                      ...
                      $tmp_html = '<div class="custom-file"><input class="custom-file-input" type="file" name="id[' . TEXT_PREFIX . $products_options_names->fields['products_options_id'] . ']"  id="' . 'attrib-' . $products_options_names->fields['products_options_id'] . '-' . $products_options_value_id . '" /><br />' . $file_attribute_value . "\n" .
