        ...
        if (zen_has_product_attributes($listing->fields['products_id']) or PRODUCT_LIST_PRICE_BUY_NOW == '0') {
          ...
          if (PRODUCT_LISTING_MULTIPLE_ADD_TO_CART != 0) {
            ...
            if ($listing->fields['products_qty_box_status'] == 0) {
              ...
              $lc_button = '<div class="input-group mb-3"><div class="input-group-prepend"><span class="input-group-text">' . TEXT_PRODUCT_LISTING_MULTIPLE_ADD_TO_CART . '</span></div>' . "<input class=\"form-control\"  type=\"text\" name=\"products_id[" . $listing->fields['products_id'] . "]\" value=\"0\" size=\"4\" />" . '</div>';
            }
          } else {
