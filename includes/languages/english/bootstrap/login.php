...
define('HEADING_TITLE', 'Welcome, Please Log In');

define('HEADING_NEW_CUSTOMER', 'New? Please Register');
...
define('HEADING_RETURNING_CUSTOMER', 'Please Log In');
...
define('TEXT_VISITORS_CART_1', '[More Info]');
