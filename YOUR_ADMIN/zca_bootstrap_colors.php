...
$sqlGroup = "SELECT configuration_group_id from " . TABLE_CONFIGURATION_GROUP  . " where configuration_group_title = 'ZCA Bootstrap Colors'";
...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="includes/css/zca_bootstrap_colors.css">
...
<div class="container"><h1><?php echo HEADING_TITLE; ?></h1></div>    
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8 configurationColumnLeft">

                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                    <tr class="dataTableHeadingRow">
                        <td class="dataTableHeadingContent"
                            width="50%"><?php echo 'Configuration Title'; ?></td>
                        <td class="dataTableHeadingContent" width="25%"><?php echo 'Configuration Value'; ?></td>
                        <td class="dataTableHeadingContent"
                            align="right" width="50%"><?php echo 'Action'; ?>&nbsp;</td>
                    </tr>
<?php
...
echo '                  <tr id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . zen_href_link(FILENAME_ZCA_BOOTSTRAP_COLORS, 'gID=' . $_GET['gID'] . '&cID=' . $cInfo->configuration_id . '&action=edit') . '\'">' . "\n";
                        } else {
 echo '                  <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . zen_href_link(FILENAME_ZCA_BOOTSTRAP_COLORS, 'gID=' . $_GET['gID'] . '&cID=' . $configuration->fields['configuration_id'] . '&action=edit') . '\'">' . "\n";
                        }
                        ?>
                        ...
                        <td class="dataTableContent"
                            align="right"><?php if ((isset($cInfo) && is_object($cInfo)) && ($configuration->fields['configuration_id'] == $cInfo->configuration_id)) {
                                ...
                                echo '<a href="' . zen_href_link(FILENAME_ZCA_BOOTSTRAP_COLORS, 'gID=' . $_GET['gID'] . '&cID=' . $configuration->fields['configuration_id']) . '" name="link_' . $configuration->fields['configuration_key'] . '">' . zen_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>';
                            } ?>&nbsp;</td>
                        </tr>
                        <?php
            ...
            <div class="col-md-4 configurationColumnRight">
                <?php
                $heading = array();
                $contents = array();
                ...
                switch ($action) {
                    case 'edit':
                        ...
                        $contents = array('form' => zen_draw_form('configuration', FILENAME_ZCA_BOOTSTRAP_COLORS, 'gID=' . $_GET['gID'] . '&cID=' . $cInfo->configuration_id . '&action=save'));
        ...
        <link rel="stylesheet" type="text/css" href="includes/css/colorpicker.css">
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/tinycolor/0.11.1/tinycolor.min.js"></script>
        ...
        <script language="javascript" src="includes/javascript/colorpicker.js"></script>       
