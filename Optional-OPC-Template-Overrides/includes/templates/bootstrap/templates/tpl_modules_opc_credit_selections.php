...
<div id="opcCreditSelections-card" class="card p-0 mb-3">
  <h4 class="card-header">
    <?php echo $current_selection['module']; ?>
  </h4>
  <div class="card-body p-3">
<div id="opcCreditSelections-content" class="content py-3"><?php echo $current_selection['redeem_instructions']; ?></div>

            <div class="gvBal larger"><?php echo (!empty($current_selection['checkbox'])) ? $current_selection['checkbox'] : ''; ?></div>
            <label class="inputLabel"<?php echo (!empty($current_field['tag'])) ? (' for="' . $current_field['tag'] . '"') : ''; ?>><?php echo $current_field['title']; ?></label>
<div class="input-group mb-3">
  <?php echo $current_field['field']; ?>
  <div class="input-group-append">
    <?php echo zen_image_button(BUTTON_IMAGE_SUBMIT, ALT_TEXT_APPLY_DEDUCTION, $additional_parms, $secondary_class); ?>
  </div>
</div>            
