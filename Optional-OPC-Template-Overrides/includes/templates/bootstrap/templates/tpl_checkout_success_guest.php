...
<!-- bof order status message -->
<div id="orderStatusMessage-card" class="card p-0 mb-3">
  <div class="card-body p-3">
    <?php echo TEXT_SEE_ORDERS_GUEST;?>
  </div>
</div>
<!-- eof order status message -->

    </div>
    <div class="col">
        
<!-- bof contact store message -->
<div id="contactStoreMessage-card" class="card p-0 mb-3">
  <div class="card-body p-3">
