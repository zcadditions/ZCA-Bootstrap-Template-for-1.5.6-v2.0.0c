...
<h4 id="shippingAddress-card-header" class="card-header">
 ...
 */
  require($template->get_template_dir('tpl_modules_checkout_new_shipping_address.php', DIR_WS_TEMPLATE, $current_page_base,'templates'). '/' . 'tpl_modules_checkout_new_shipping_address.php');
?>
...
<?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></h4>
...
<?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>'; ?></div>
